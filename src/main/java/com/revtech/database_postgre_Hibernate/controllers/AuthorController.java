...
public class AuthorController {
	...
	public AuthorController(AuthorService authorService,Mapper<AuthorEntity, AuthorDto> authMapper){
		this.authorService = authorService;
		this.authorMapper = authMapper;
	}
	...
	public ResponseEntity<AuthorDto> getAuthor(@PathVariable("id") Long id){
		...
		return foundAuthor.map(authorEnitity -> {
			AuthorDto authorDto = authorMapper.mapTo(authorEnitity);
